...
import ai.pipestream.receipt.verify.RecordWire.Artifact;
import ai.pipestream.receipt.verify.RecordWire.Completeness;
import ai.pipestream.receipt.verify.RecordWire.Issuer;
import ai.pipestream.receipt.verify.RecordWire.Key;
import ai.pipestream.receipt.verify.RecordWire.Manifest;
import ai.pipestream.receipt.verify.RecordWire.Sig;
import ai.pipestream.receipt.verify.RecordWire.Signed;
import ai.pipestream.receipt.verify.RecordWire.Step;
import ai.pipestream.receipt.verify.RecordWire.Subject;
import ai.pipestream.receipt.verify.RecordWire.Trust;
