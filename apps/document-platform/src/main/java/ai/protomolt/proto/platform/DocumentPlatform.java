...
import ai.protomolt.proto.metric.iceberg.IcebergMetricExecutor;
import ai.protomolt.proto.metric.iceberg.IcebergRollupSink;
import ai.protomolt.proto.metric.iceberg.IcebergRollupSubjects;
...
import ai.protomolt.proto.search.snapshot.s3.S3SnapshotStore;
...
public final class DocumentPlatform implements AutoCloseable {
    ...
    private final ai.protomolt.proto.config.DistributedConfig distributedConfig;
    ...
    private final java.util.concurrent.atomic.AtomicReference
            <ai.protomolt.proto.authz.AccessPolicy> accessPolicy =
    ...
    private DocumentPlatform(DocumentPlatformConfig config, ApiKeyIdentityResolver resolver)
        ...
        if (accessPolicyFile != null) {
            try {
                ai.protomolt.proto.authz.AccessPolicy bootPolicy =
        ...
        RollupSink rollupSink = lakeConfig != null
                ...
                : defaultRollupLake;
        ai.protomolt.proto.metric.spi.MetricSubjectResolver rollupSubjects =
                lakeConfig != null
        ...
        List<ai.protomolt.proto.composer.ServiceModule> selected = new ArrayList<>();
        for (ai.protomolt.proto.composer.ServiceModule module
                : new ai.protomolt.proto.composer.ServiceModule[] {
        ...
        for (ai.protomolt.proto.composer.ServiceModule module : selected) {
        ...
        try {
            ...
            if (configRefreshSeconds > 0) {
                ...
                ai.protomolt.proto.config.kafka.KafkaConfigSource.Config kafka =
                        kafkaConfigFamily(config.environment());
                ai.protomolt.proto.config.ConfigSource configSource;
                if (kafka != null) {
                    configSource = new ai.protomolt.proto.config.kafka.KafkaConfigSource(
                            kafka);
                } else {
                    ...
                    configSource = new ai.protomolt.proto.config.registry
                            .RegistryConfigSource(configUrl, apiToken);
                }
                this.distributedConfig = ai.protomolt.proto.config.DistributedConfig
                        .over(configSource);
                if (parse != null) {
                    ai.protomolt.proto.config.DistributedConfig
                            .Subscription<ai.protomolt.proto.parse.v1.RoutingConfig> routing =
                            distributedConfig.subscribe(PARSE_ROUTING_CONFIG_SUBJECT,
                                    ai.protomolt.proto.parse.v1.RoutingConfig
                                            .getDefaultInstance());
                ...
                if (taxonomies != null) {
                    ...
                    taxonomies.swap(ai.protomolt.proto.config.TaxonomyMounts
                ...
                if (postalCodes != null) {
                    ...
                    postalCodes.swap(ai.protomolt.proto.config.PostalCodeMounts
                            .follow(distributedConfig));
                    LOG.info("postal-code pack following '{}'",
                            ai.protomolt.proto.config.PostalCodeMounts.SUBJECT);
                }
                if (screening != null) {
                    ...
                    distributedConfig.subscribe(subject,
                            ai.protomolt.proto.types.ScreeningConfig.getDefaultInstance())
                ...
                if (callers != null) {
                    ...
                    distributedConfig.subscribe(
                            ai.protomolt.proto.config.AccessPolicyMounts.SUBJECT,
                            ai.protomolt.proto.authz.AccessPolicy.getDefaultInstance())
    ...
    private static final class LocalLakeRollupSink
            implements ai.protomolt.proto.metric.spi.RollupSink {

        private final Path dir;
        private JdbcCatalog catalog;
        private ai.protomolt.proto.metric.spi.RollupSink delegate;
        ...
        public synchronized Written replace(String sourceSubject, String table,
                ...
                List<ai.protomolt.proto.metric.MetricRow> rows) {
            initialize(true);
    ...
    private static Catalog metricsCatalog(MetricsIcebergConfig config) {
        ...
        if (config.s3()) {
            ...
            properties.putAll(ai.protomolt.proto.iceberg.s3.S3Catalogs
     ...
     * stays live.
     */
    static ai.protomolt.proto.screening.Screener mountScreener(
            ai.protomolt.proto.types.ScreeningConfig config) {
        ...
        try (java.io.InputStream model = java.nio.file.Files.newInputStream(path)) {
            return new ai.protomolt.proto.screening.Screener(
                    ai.protomolt.proto.screening.OpenNlpScreeningEngine.load(model),
                    config);
     ...
     */
    static ai.protomolt.proto.config.kafka.KafkaConfigSource.Config kafkaConfigFamily(
            Map<String, String> environment) {
        ...
        return new ai.protomolt.proto.config.kafka.KafkaConfigSource.Config(
                bootstrap,
                topic.isEmpty()
