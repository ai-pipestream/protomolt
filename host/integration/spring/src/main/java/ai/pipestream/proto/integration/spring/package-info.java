 ...
 *
 * <p>{@link ai.pipestream.proto.integration.spring.ProtoToolsAutoConfiguration} contributes the core object
 ...
 * {@link ai.pipestream.proto.http.json.ProtobufJsonTranscoder}, and the REST types
 * ({@link ai.pipestream.proto.http.rest.ProtoRestMethodRegistry},
 * {@link ai.pipestream.proto.http.rest.ProtoApiTokenValidator}, and
 * {@link ai.pipestream.proto.http.rest.ProtoRestGateway}). It is registered through
 ...
 * {@link ai.pipestream.proto.http.rest.ProtoApiTokenValidator} rejects all tokens; applications define
