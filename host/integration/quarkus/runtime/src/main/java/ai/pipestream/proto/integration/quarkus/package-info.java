 ...
 *
 * <p>{@link ai.pipestream.proto.integration.quarkus.ProtoToolsProducer} exposes the core object graph as CDI
 * producers: a {@link ai.pipestream.proto.descriptors.DescriptorRegistry}, a
 * {@link ai.pipestream.proto.mapper.ProtoFieldMapper}, a
 * {@link ai.pipestream.proto.http.json.ProtobufJsonTranscoder}, a
 * {@link ai.pipestream.proto.server.ProtoToolsServerConfig}, and the REST types
 * ({@link ai.pipestream.proto.http.rest.ProtoRestMethodRegistry},
 * {@link ai.pipestream.proto.http.rest.ProtoApiTokenValidator}, and
 * {@link ai.pipestream.proto.http.rest.ProtoRestGateway}). Each is a
 ...
 * {@link ai.pipestream.proto.http.rest.ProtoApiTokenValidator} rejects all tokens; applications produce
 ...
 */
package ai.pipestream.proto.integration.quarkus;
