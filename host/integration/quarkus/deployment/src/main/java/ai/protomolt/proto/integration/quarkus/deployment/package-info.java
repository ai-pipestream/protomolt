 ...
 *
 * <p>{@link ai.protomolt.proto.integration.quarkus.deployment.ProtoToolsProcessor} declares the build steps
 * Quarkus runs during augmentation: it registers the {@code protomolt} feature, adds
 * {@link ai.protomolt.proto.integration.quarkus.ProtoToolsProducer} as an unremovable bean — extension jars
 ...
 * they honor, are documented on the runtime package {@link ai.protomolt.proto.integration.quarkus}.
 *
 * <p>See the
