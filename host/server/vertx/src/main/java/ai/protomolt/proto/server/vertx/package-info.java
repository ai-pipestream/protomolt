 ...
 *
 * <p>{@link ai.protomolt.proto.server.vertx.VertxProtoRestServer} implements
 * {@link ai.protomolt.proto.server.ProtoRestServerHost} on a Vert.x
 * {@link io.vertx.core.http.HttpServer}, serving the invoke, OpenAPI, and health routes and
 * delegating request handling to
 * {@link ai.protomolt.proto.http.rest.ProtoRestGateway}. It either creates its own
 ...
 * and servers</a> guide.
 */
package ai.protomolt.proto.server.vertx;
