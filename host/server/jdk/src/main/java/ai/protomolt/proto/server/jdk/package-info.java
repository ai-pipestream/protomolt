 ...
 *
 * <p>{@link ai.protomolt.proto.server.jdk.JdkProtoRestServer} implements
 * {@link ai.protomolt.proto.server.ProtoRestServerHost} on
 ...
 * {@link ai.protomolt.proto.http.rest.ProtoRestGateway}; the class binds the invoke, OpenAPI, and
 * health routes and applies the shared status mapping from
 * {@link ai.protomolt.proto.server.ProtoRestHttpSupport}.
 *
 ...
 * and servers</a> guide.
 */
package ai.protomolt.proto.server.jdk;
