 ...
 * ai.pipestream.proto.composer.ServiceModule} via {@link
 * java.util.ServiceLoader}, the {@link ai.pipestream.proto.composer.Composer}
 * orders them by requirements and runs the two-phase wire/start lifecycle,
 * and {@link ai.pipestream.proto.composer.Channels} pivots each
