...
/**
 * Connection and migration settings for the workflow-runs store.
 * <p>
 ...
 */
public record WorkflowRunStoreConfig(
        String jdbcUrl,
        String username,
        String password,
        int maxPoolSize,
    ...
    public WorkflowRunStoreConfig {
        if (jdbcUrl == null || jdbcUrl.isBlank()) {
            throw new IllegalArgumentException("jdbcUrl is required: the workflow-runs store "
     ...
     */
    public WorkflowRunStoreConfig(String jdbcUrl, String username, String password) {
