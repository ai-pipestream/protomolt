...
public interface WorkflowRunStore {
     ...
     */
    InsertOutcome insert(WorkflowRunRecord job, WorkflowRunEventRecord event);
     ...
     */
    Optional<WorkflowRunRecord> get(UUID jobId);

    /**
     * Page jobs, newest first. Null filters match everything.
     *
     * @param statusOrNull restrict to this status, or null
     * @param workflowNameOrNull restrict to this workflow, or null
     * @param limit page size
     * @param offset rows to skip
     * @return the page (possibly empty)
     */
    List<WorkflowRunRecord> list(String statusOrNull, String workflowNameOrNull, int limit, long offset);
     ...
     */
    List<WorkflowRunEventRecord> pollPendingEvents(int limit);
     ...
     */
    Optional<WorkflowRunEventRecord> markEventFailed(WorkflowRunEventRecord event, String error);
}
