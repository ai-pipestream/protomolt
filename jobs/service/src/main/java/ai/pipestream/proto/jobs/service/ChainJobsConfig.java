...
/**
 * The chain-jobs worker/relay/consumer configuration. A plain value object —
 ...
 * @param requestTopic the ChainJobRequest topic to consume, or null to run
 *        without broker-native submission
 * @param eventsTopic the ChainJobEvent topic the relay publishes to
