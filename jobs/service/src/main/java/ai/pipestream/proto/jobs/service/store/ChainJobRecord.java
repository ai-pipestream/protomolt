...
public final class ChainJobRecord {
    ...
    /** Terminal: the chain ran to completion. */
    ...
    /** The raw chain JSON envelope, snapshotted at submit. */
    public String chainDefinition;
    /** The chain input, proto3 JSON. */
    public String input;
    ...
    /** The chain's composed output (raw JSON text); set on COMPLETED. */
