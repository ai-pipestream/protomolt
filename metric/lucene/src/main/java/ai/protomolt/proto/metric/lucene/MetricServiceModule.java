...
import ai.protomolt.proto.metric.service.MetricActions;
import ai.protomolt.proto.metric.service.MetricServices;
import ai.protomolt.proto.metric.service.MetricWorkflows;
import ai.protomolt.proto.metric.service.ServedMetricSubject;
...
public final class MetricServiceModule implements ServiceModule {
    ...
    /** The role name. */
    public static final String ROLE = "metric";
    ...
    public record Config(int grpcPort, Map<String, Subject> subjects,
            ai.protomolt.proto.metric.spi.RollupSink rollupSink,
            ai.protomolt.proto.metric.spi.MetricSubjectResolver subjectResolver,
            String apiToken,
            CallerResolver callers,
            java.util.function.Supplier<ai.protomolt.proto.authz.AccessPolicy>
                    accessPolicy) {
