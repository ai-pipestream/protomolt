...
import ai.pipestream.proto.authz.MetricMemberDeny;
import ai.pipestream.proto.authz.MetricRowFilter;
    ...
    static void boot() throws Exception {
        ...
        service = MetricServices.build(Map.of("orders", orders), null,
                name -> "rollup:orders".equals(name)
                        ? new ai.pipestream.proto.metric.spi.MetricSubjectResolver
