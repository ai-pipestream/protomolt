...
*Iceberg's* generic reader across nested structs, lists, maps, timestamps,
and JSON columns. Drift between the emitter's shapes and what Iceberg readers
...
hatch to any S3-compatible store, including RustFS, SeaweedFS, Ceph, and AWS S3, through
