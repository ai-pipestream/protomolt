...
```
['ai.protomolt.proto.grpc.service.v1.ProtoMoltService', 'grpc.reflection.v1.ServerReflection']
```
...
```
gen/ai/protomolt/proto/grpc/service/v1/protomolt_service_pb2.py
```
...
import grpc
from ai.protomolt.proto.grpc.service.v1 import protomolt_service_pb2 as pb2
...
compile_rpc = channel.unary_unary(
    "/ai.protomolt.proto.grpc.service.v1.ProtoMoltService/Compile",
...
versions, and render JSON Schema: the server verbs speak the same envelopes
over gRPC and REST, with the host-independent subset available over standalone
MCP. See the [generated action inventory](../generated/action-inventory.json)
for the exact surface name sets.
