...
seventeen verbs on every surface.

The service is defined in protobuf, of course:
`ai.pipestream.protomolt.v1.ProtoMoltService`, seventeen typed RPCs in
...
`GET /openapi.json` documents all seventeen operations with schemas derived
