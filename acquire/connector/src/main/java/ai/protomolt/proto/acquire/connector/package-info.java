 ...
 *
 * <p>{@link ai.protomolt.proto.acquire.connector.StreamSource} is the contract: open it with a plan and
 * messages arrive on a listener until the stream ends, fails, or is closed. Each source kind
 * declares its own {@link ai.protomolt.proto.acquire.connector.SourcePlan} record carrying exactly what
 * it needs, so plans stay type-safe rather than collapsing into a property bag. Two
 * implementations ship here — {@link ai.protomolt.proto.acquire.connector.GrpcStreamSource} over a
 * server-streaming method described by {@link ai.protomolt.proto.acquire.connector.GrpcSourcePlan}, and
 * {@link ai.protomolt.proto.acquire.connector.KafkaSource} over a topic described by
 * {@link ai.protomolt.proto.acquire.connector.KafkaSourcePlan}. Failures surface as
 * {@link ai.protomolt.proto.acquire.connector.SourceException}.</p>
 *
 * <p>{@link ai.protomolt.proto.acquire.connector.SourcePump} bridges a source to a synchronous consumer:
 ...
 */
package ai.protomolt.proto.acquire.connector;
