 ...
 *
 * <p>{@link ai.pipestream.proto.acquire.connector.StreamSource} is the contract: open it with a plan and
 * messages arrive on a listener until the stream ends, fails, or is closed. Each source kind
 * declares its own {@link ai.pipestream.proto.acquire.connector.SourcePlan} record carrying exactly what
 * it needs, so plans stay type-safe rather than collapsing into a property bag. Two
 * implementations ship here — {@link ai.pipestream.proto.acquire.connector.GrpcStreamSource} over a
 * server-streaming method described by {@link ai.pipestream.proto.acquire.connector.GrpcSourcePlan}, and
 * {@link ai.pipestream.proto.acquire.connector.KafkaSource} over a topic described by
 * {@link ai.pipestream.proto.acquire.connector.KafkaSourcePlan}. Failures surface as
 * {@link ai.pipestream.proto.acquire.connector.SourceException}.</p>
 *
 * <p>{@link ai.pipestream.proto.acquire.connector.SourcePump} bridges a source to a synchronous consumer:
 ...
 *
 * <p>Byte-oriented sources delegate framing to a {@link ai.pipestream.proto.acquire.connector.MessageParser},
 ...
 */
package ai.pipestream.proto.acquire.connector;
