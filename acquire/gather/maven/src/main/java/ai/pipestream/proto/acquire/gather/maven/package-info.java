 ...
 * {@link ai.pipestream.proto.acquire.gather.ProtoGatherer} using the standalone Maven Resolver, so no
 ...
 * {@link ai.pipestream.proto.acquire.gather.JarProtoExtraction}, so in-jar paths become import paths
