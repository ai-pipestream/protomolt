 ...
 *
 * <p>{@link ai.pipestream.proto.acquire.pull.IntakeFeed} is the submission seam;
 * {@link ai.pipestream.proto.acquire.pull.PullDocuments} wraps a source item into a
 * stable-identity document (same source item, same doc id, so an updated item replaces rather
 * than duplicates); {@link ai.pipestream.proto.acquire.pull.PullReport} is the watermark-carrying
