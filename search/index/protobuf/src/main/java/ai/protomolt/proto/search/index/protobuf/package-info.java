 ...
 * {@link ai.protomolt.proto.search.index.spi.IndexMapping} through an
 * {@link ai.protomolt.proto.search.index.spi.IndexMappingFactory}, validates instances with an
 * optional {@link ai.protomolt.proto.validate.ProtoValidator}, and writes NDJSON lines — plain
 * or bulk-index pairs — with {@link ai.protomolt.proto.search.index.ndjson.ProtoNdjsonWriter}. The
