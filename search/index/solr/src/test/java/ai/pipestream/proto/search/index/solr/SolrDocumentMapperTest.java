...
class SolrDocumentMapperTest {
    ...
    void mapModeFlattenEmitsUnderscoreKeyFields() throws Exception {
        Map<String, Object> doc = mapper.map(labelsMessage(),
                mapModeMapping(ai.pipestream.proto.search.index.spi.MapMode.FLATTEN));
    ...
    void mapModeJsonEmitsOneJsonString() throws Exception {
        Map<String, Object> doc = mapper.map(labelsMessage(),
                mapModeMapping(ai.pipestream.proto.search.index.spi.MapMode.JSON));
    ...
    void mapModeSkipOmitsField() throws Exception {
        Map<String, Object> doc = mapper.map(labelsMessage(),
                mapModeMapping(ai.pipestream.proto.search.index.spi.MapMode.SKIP));
    ...
    private IndexMapping mapModeMapping(ai.pipestream.proto.search.index.spi.MapMode mode) throws Exception {
