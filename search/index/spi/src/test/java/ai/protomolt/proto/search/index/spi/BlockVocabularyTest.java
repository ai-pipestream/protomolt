...
class BlockVocabularyTest {
        ...
        DescriptorProto article = DescriptorProto.newBuilder().setName("Article")
                .addField(FieldDescriptorProto.newBuilder()
                        ...
                        .setOptions(hint(FieldIndexHint.newBuilder()
                                ...
                                .setBlockRole(ai.protomolt.proto.search.index.hints.BlockRole.BLOCK_ROLE_DOC_ID)
                                .build())))
                .addField(FieldDescriptorProto.newBuilder()
                ...
                .addField(FieldDescriptorProto.newBuilder()
                        ...
                        .setOptions(hint(FieldIndexHint.newBuilder()
                                ...
                                .setBlockRole(ai.protomolt.proto.search.index.hints.BlockRole.BLOCK_ROLE_CHUNKS)
                                .build())))
                .build();
    ...
    void chunkingPolicyTranslatesFromProtoOptionsAndRequiresAStringField() throws Exception {
        FieldIndexHint policyHint = FieldIndexHint.newBuilder()
                ...
                .setChunkingPolicy(ai.protomolt.proto.search.index.hints.ChunkingPolicy.newBuilder()
                        .setChunking(ai.protomolt.proto.search.index.hints.ChunkingSpec.newBuilder()
                        ...
                        .setEmbedding(ai.protomolt.proto.search.index.hints.EmbeddingSpec.newBuilder()
