    ...
    private static Descriptor richHintedDescriptor() throws Exception {
        DescriptorProtos.FieldOptions embeddingOptions = DescriptorProtos.FieldOptions.newBuilder()
                .setExtension(IndexingHintsProto.index, FieldIndexHint.newBuilder()
                        .setType(ai.pipestream.proto.search.index.hints.IndexFieldType.INDEX_FIELD_TYPE_VECTOR)
                        .setVectorDims(3)
                        .setVectorSimilarity(ai.pipestream.proto.search.index.hints.VectorSimilarity.VECTOR_SIMILARITY_L2)
                        .setVectorElementType(
                                ai.pipestream.proto.search.index.hints.VectorElementType.VECTOR_ELEMENT_TYPE_BYTE)
                        .setHnsw(ai.pipestream.proto.search.index.hints.HnswParams.newBuilder()
                                .setM(16)
                                .setEfConstruction(200))
                        .addSubFields(ai.pipestream.proto.search.index.hints.SubFieldHint.newBuilder()
                                .setType(ai.pipestream.proto.search.index.hints.IndexFieldType.INDEX_FIELD_TYPE_KEYWORD)
                                .setName("raw")
                        ...
                        .setSortable(true)
                        .setFacetable(true)
                        .setMapMode(ai.pipestream.proto.search.index.hints.MapMode.MAP_MODE_JSON)
                        .setDateFormat("epoch_millis")
                        .setDateResolution(ai.pipestream.proto.search.index.hints.DateResolution.DATE_RESOLUTION_SECONDS)
