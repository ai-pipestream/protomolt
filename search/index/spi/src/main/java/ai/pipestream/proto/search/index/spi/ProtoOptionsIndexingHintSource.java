...
public final class ProtoOptionsIndexingHintSource implements IndexingHintSource {
    ...
    private static BlockRole toBlockRole(ai.pipestream.proto.search.index.hints.BlockRole role) {
        return switch (role) {
    ...
    private static ChunkingPolicy toPolicy(ai.pipestream.proto.search.index.hints.ChunkingPolicy policy) {
    ...
    private static VectorSimilarity toSimilarity(ai.pipestream.proto.search.index.hints.VectorSimilarity similarity) {
    ...
    private static VectorElementType toElementType(ai.pipestream.proto.search.index.hints.VectorElementType elementType) {
    ...
    private static MapMode toMapMode(ai.pipestream.proto.search.index.hints.MapMode mapMode) {
    ...
    private static DateResolution toResolution(ai.pipestream.proto.search.index.hints.DateResolution resolution) {
