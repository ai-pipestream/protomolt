package ai.pipestream.proto.search.snapshot.s3;
...
/**
 * The S3 implementation of the door's snapshot seam: one bucket, an
 * optional root prefix, whole-file puts and gets. Only immutable commit
 * files move through here; the door never runs a live Lucene directory
 * over object storage.
 */
