...
/**
 * The screening mount at the index door: a door built with a screening
...
class ScreeningDoorTest {
    ...
    @BeforeAll
    static void bootScreenedDoor() throws Exception {
        DocumentFetcher fetcher = address -> DOCUMENT;
        door = SearchDoorServices.build(
                new SearchDoorConfig(0, work.resolve("screened"), Map.of(
    ...
    @Test
    @Order(1)
    void aConfiguredDoorWithoutALiveMountRefusesFailClosed() {
