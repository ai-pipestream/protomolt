...
/**
 * The metric door under identity: describing and querying require metrics-query, the
...
class ScopedMetricDoorTest {
    ...
    private static MetricDoorServices door;
    ...
    static void boot() throws Exception {
        ...
        door = MetricDoorServices.build(Map.of("orders", new ServedMetricSubject(mapping,
                Map.of(MetricBackend.METRIC_BACKEND_LUCENE,
                        new MetricDoorServicesTest.FakeExecutor()))));
