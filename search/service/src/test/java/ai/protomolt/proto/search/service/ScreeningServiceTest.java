...
import ai.protomolt.proto.screening.ScreeningEngine;
...
class ScreeningServiceTest {
    ...
    void theMaskMountRedactsTheScreenedFieldAndCarriesEvidence() {
        ...
        var search = ai.protomolt.proto.search.v1.SearchServiceGrpc
                .newBlockingStub(channel);
        assertThat(search.search(ai.protomolt.proto.search.v1.SearchRequest.newBuilder()
                .setMappingSubject("repo-document-lexical").setQuery("Ada").setK(10)
                .setLane(ai.protomolt.proto.search.v1.SearchLane.SEARCH_LANE_LEXICAL)
                .build())
                .getHitsList())
