 ...
 */
class SearchServiceModuleSnapshotTest {
    ...
    void aRebootedNodeRestoresItsIndexFromTheSnapshotStore() throws Exception {
        ...
        SearchServiceModule first = new SearchServiceModule(new SearchServiceModule.Config(
        ...
        try (Composer.Node node = Composer.emptyBuilder()
                .module(new SearchServiceModuleTest.FakeRepoModule(document))
                .module(first)
                .environment(Map.of())
                .build()
        ...
        SearchServiceModule second = new SearchServiceModule(new SearchServiceModule.Config(
