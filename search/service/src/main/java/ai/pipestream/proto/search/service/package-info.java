 ...
 *
 * <p>{@link ai.pipestream.proto.search.service.SearchServices} wires the
 * stack; {@link ai.pipestream.proto.search.service.SearchServiceModule} mounts it
 * as the {@code search} role over a co-mounted or remote {@code repo} role.
 * {@link ai.pipestream.proto.search.service.RepoDocumentMapping} is the
