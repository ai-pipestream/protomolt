 ...
 * ai.pipestream.proto.search.index.spi.ChunkingPolicy} names a strategy, a pinned
 * implementation version, and a boundary rule set; {@link
 * ai.pipestream.proto.search.chunk.SentencePackedChunker} executes exactly one
