 ...
 * Rerank-provider SPI.
 *
 * <p>{@link ai.pipestream.proto.search.rerank.RerankProvider} is the ServiceLoader contract: a
 ...
 * {@link ai.pipestream.proto.search.rerank.RerankProviders} discovers implementations and resolves
