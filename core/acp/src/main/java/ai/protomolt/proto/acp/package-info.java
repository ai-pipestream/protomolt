 ...
 *
 * <p>{@link ai.protomolt.proto.acp.AcpAgent} is the agent runtime: it answers
 * {@code initialize}, {@code session/new}, and {@code session/prompt}, delegating each prompt
 * turn to the {@link ai.protomolt.proto.acp.PromptHandler} it was built with and streaming the
 * handler's output back as {@code session/update} chunks through
 * {@link ai.protomolt.proto.acp.PromptContext}. {@link ai.protomolt.proto.acp.AcpClient} is
 ...
 * {@link ai.protomolt.proto.acp.AcpError}.</p>
 *
