 ...
 *
 * <p>{@link ai.protomolt.proto.validate.protovalidate.ProtovalidateRuleSource} reads
 * {@code (buf.validate.field)} and {@code (buf.validate.message)} options off descriptors and
 * translates them into the neutral {@link ai.protomolt.proto.validate.model.FieldConstraints} and
 * {@link ai.protomolt.proto.validate.model.MessageConstraints} model, so schemas annotated for
 * protovalidate validate through {@link ai.protomolt.proto.validate.ProtoValidator} unchanged.
 ...
 * extension registry.
 *
 * <p>The class implements {@link ai.protomolt.proto.validate.spi.ValidationRuleSource} and is
