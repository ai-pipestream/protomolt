...
import ai.pipestream.proto.validate.buf.testdata.BufUser;
import ai.pipestream.proto.validate.buf.testdata.Plan;
...
class BufValidateRuleSourceTest {
    ...
    void requiredAndStringRules() {
        assertViolation(BufUser.newBuilder()
                        .setPlan(Plan.PLAN_FREE)
