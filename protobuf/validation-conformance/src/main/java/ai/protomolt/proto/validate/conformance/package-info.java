 ...
 *
 * <p>{@link ai.protomolt.proto.validate.conformance.ConformanceRunner} is the shared core: it
 * runs {@link ai.protomolt.proto.validate.ProtoValidator} over a single case and expresses the
 * outcome the way the suite compares it, expanding each
 * {@link ai.protomolt.proto.validate.ValidationResult.Violation} into the structured field and
 * rule paths the runner checks with message equality.
 *
 * <p>{@link ai.protomolt.proto.validate.conformance.ConformanceMain} is the executor entry point
 ...
 * {@link ai.protomolt.proto.validate.protovalidate.ProtovalidateRuleSource}, which this module
