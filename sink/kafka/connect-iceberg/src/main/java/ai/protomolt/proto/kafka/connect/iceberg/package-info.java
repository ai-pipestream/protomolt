 ...
 *
 * <p>{@link ai.protomolt.proto.kafka.connect.iceberg.IcebergSinkConnector} is the entry point a
 * worker registers, {@link ai.protomolt.proto.kafka.connect.iceberg.IcebergSinkConfig} declares
 * its settings, and {@link ai.protomolt.proto.kafka.connect.iceberg.IcebergSinkTask} decodes each
 * delivered batch into row messages and commits it as one snapshot through
 * {@link ai.protomolt.proto.iceberg.IcebergSink}. Rows are written by ProtoMolt's
 ...
 */
package ai.protomolt.proto.kafka.connect.iceberg;
