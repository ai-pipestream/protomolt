...
final class SerdeMapper {
     ...
     * class.
     *
     * @throws ai.protomolt.proto.mapper.MappingException  when a rule's path does not fit the
     *                                                      message
     * @throws ai.protomolt.proto.cel.CelEvaluationException when a CEL expression fails to
     *                                                        compile or evaluate
     */
    Message apply(Message message) throws ai.protomolt.proto.mapper.MappingException {
