 ...
 *
 * <p>{@link ai.protomolt.proto.kafka.serde.ProtoMoltProtobufSerializer} and
 * {@link ai.protomolt.proto.kafka.serde.ProtoMoltProtobufDeserializer} are the two entry points,
 * paired as one {@link ai.protomolt.proto.kafka.serde.ProtoMoltSerde} for Kafka Streams. Both
 * halves read the same {@link ai.protomolt.proto.kafka.serde.ProtoMoltSerdeConfig}: the schema
 ...
 * {@link ai.protomolt.proto.kafka.wire.ConfluentWireFormat} implements in both directions.</p>
 *
 ...
 *
 * <p>{@link ai.protomolt.proto.kafka.serde.SerdeMetricsListener} is the extension point.
