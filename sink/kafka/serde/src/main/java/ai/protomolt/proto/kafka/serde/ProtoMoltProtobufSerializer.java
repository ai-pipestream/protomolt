...
public class ProtoMoltProtobufSerializer implements Serializer<Message> {
    ...
    private ai.protomolt.proto.quality.QualityScorer quality;
    ...
    private ai.protomolt.proto.compat.CompatibilityChecker compatChecker;
    // Verdicts on (packaged file, registry file) pairs; both sides are cached instances.
    private final ConcurrentMap<SchemaPair, ai.protomolt.proto.compat.CompatibilityResult>
    ...
    public void configure(Map<String, ?> configs, boolean isKey) {
        ...
        quality = ai.protomolt.proto.quality.QualityScorer.create();
        ...
        compatChecker = ai.protomolt.proto.compat.CompatibilityChecker.create();
    ...
    public byte[] serialize(String topic, Message data) {
        ...
        if (mapper != null) {
            ...
            } catch (ai.protomolt.proto.mapper.MappingException
                     | ai.protomolt.proto.cel.CelEvaluationException e) {
    ...
    private void measureQuality(String topic, Descriptor packaged, Message contract) {
        ai.protomolt.proto.quality.QualityReport report = quality.score(contract);
        if (!report.scored()) {
            return;
        }
    ...
    private void ensureLatestCanRead(String topic, Descriptor packaged, Descriptor latest,
        ...
        ai.protomolt.proto.compat.CompatibilityResult verdict = compatVerdicts.computeIfAbsent(
                new SchemaPair(packaged.getFile(), latest.getFile()),
                pair -> compatChecker.check(pair.packaged(), pair.latest(),
                        ai.protomolt.proto.compat.CompatibilityMode.BACKWARD));
