 ...
 * schema conversion, appends — stays in {@link ai.pipestream.proto.iceberg}, whose
 * {@link ai.pipestream.proto.iceberg.LocalFileIO} is the local-filesystem counterpart to
 * this package.</p>
 *
 ...
 */
package ai.pipestream.proto.iceberg.s3;
