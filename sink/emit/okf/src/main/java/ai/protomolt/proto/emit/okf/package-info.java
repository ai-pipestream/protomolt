 ...
 * {@link ai.protomolt.proto.registry.SchemaRegistryStore} the same way, adding a concept per
 * subject with its version table.</p>
 *
 * <p>{@link EmitOkfAction} exposes the renderer as the {@code emit-okf} verb, an
 * {@link ai.protomolt.proto.actions.ProtoAction} that returns the bundle inline. Delivery is a
 * separate step through {@link ai.protomolt.proto.emit.BundleSink}; no destination rides in the
 * request.</p>
 *
