/**
 * Lands {@link ai.protomolt.proto.emit.parquet.ParquetEmitter}'s Parquet bytes on an
 * S3-compatible object store.
 *
 * <p>{@link ai.protomolt.proto.emit.parquet.s3.S3ParquetSink} takes a descriptor, a
 * batch of messages and an object key, renders the file in memory and uploads it with
 * one {@code putObject}. {@link ai.protomolt.proto.emit.parquet.s3.S3Clients} builds the
