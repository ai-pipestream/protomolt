 ...
 *
 * <p>{@link ai.protomolt.proto.cel.CelEnvironmentFactory} builds an environment from message
 * descriptors, variable declarations, and application-supplied function bindings.
 * {@link ai.protomolt.proto.cel.CelEvaluator} compiles and evaluates expressions in that
 ...
 * {@link ai.protomolt.proto.cel.CelCompilationException} and evaluation errors as
 * {@link ai.protomolt.proto.cel.CelEvaluationException}, so callers can tell a bad rule from a
 * bad message. {@link ai.protomolt.proto.cel.CelValidation} compiles an expression for
