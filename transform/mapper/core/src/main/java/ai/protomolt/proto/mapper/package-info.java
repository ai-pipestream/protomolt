 ...
 *
 * <p>{@link ai.protomolt.proto.mapper.ProtoFieldMapper} is the entry point: it reads and writes
 * fields by dot-notation path and applies lists of text rules to a message builder.
 * {@link ai.protomolt.proto.mapper.ProtoFieldMapperImpl} is the descriptor-driven implementation,
 * built over a {@link ai.protomolt.proto.descriptors.DescriptorRegistry} so dynamic messages,
 ...
 * {@link ai.protomolt.proto.mapper.MappingException}.</p>
 *
