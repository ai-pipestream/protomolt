...
import ai.protomolt.proto.pipeline.v1.StructuredStep;
...
final class PipelineFixtures {
    ...
    static String fingerprint() {
        ...
        return ai.protomolt.proto.grpc.profile.ServiceProfileValidation
    ...
    static PipelineStep.Builder grpcStep(String name, String service, String method,
                                         ...
                                         ai.protomolt.proto.grpc.workflow.v1.TypedEdge
                                                 edge) {
        GrpcCallStep.Builder call = GrpcCallStep.newBuilder()
                ...
                .setCompletion(ai.protomolt.proto.grpc.workflow.v1.StepCompletion
    ...
    static ai.protomolt.proto.grpc.workflow.v1.TypedEdge edge(String produceType,
                                                              List<String> sources,
                                                              String... rules) {
        return ai.protomolt.proto.grpc.workflow.v1.TypedEdge.newBuilder()
    ...
    static PipelineStep structuredStep(String name, String dependency, String model,
                                       ai.protomolt.proto.grpc.workflow.v1.TypedEdge edge) {
        StructuredStep.Builder structured = StructuredStep.newBuilder()
                .setSpec(ai.protomolt.proto.grpc.workflow.v1.StructuredGenerationSpec
                        .newBuilder()
