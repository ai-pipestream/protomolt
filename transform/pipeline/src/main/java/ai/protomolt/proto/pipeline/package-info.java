 ...
 *
 * <p>A {@link ai.protomolt.proto.pipeline.v1.Pipeline} is the compiled, streaming-aware form
 * of a {@link ai.protomolt.proto.grpc.workflow.v1.Workflow}: every gRPC or structured step is
 * fed by an explicit typed edge (embedded unchanged from the workflow contract, so mapping, CEL,
 ...
 * cardinality. {@link WorkflowPipelineCompiler} performs the workflow-to-pipeline compilation;
