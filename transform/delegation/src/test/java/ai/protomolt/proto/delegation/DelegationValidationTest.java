...
import static ai.protomolt.proto.delegation.DelegationFixtures.commit;
import static ai.protomolt.proto.delegation.DelegationFixtures.evidence;
...
class DelegationValidationTest {
    ...
    void aTranscriptEntrysLaneMustMatchItsFrame() {
        TranscriptEntry crossed = TranscriptEntry.newBuilder()
                ...
                .setWorkerId("worker-sol-1")
                .setCoordinatorFrame(ai.protomolt.proto.delegation.v1.DelegateResponse
                        .newBuilder()
                        .setFrameId(DelegationFixtures.uuid("frame"))
                        .setSeq(1)
