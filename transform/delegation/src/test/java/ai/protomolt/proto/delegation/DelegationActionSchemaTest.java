...
class DelegationActionSchemaTest {
    ...
    /**
     * The request message's own description. A verb manifest describes its root in place,
     * because a tool-calling client reads the root's properties directly and cannot follow
     * a reference to find them. Nested types stay in the definitions block, where a message
     * reaching the same type twice is still described once.
     */
