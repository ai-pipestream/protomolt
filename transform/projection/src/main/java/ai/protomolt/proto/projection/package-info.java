 ...
 *
 * <p>{@link ai.protomolt.proto.projection.MessageProjection} is the entry point: it compiles a
 ...
 * {@link ai.protomolt.proto.projection.MessageProjection#registerExtensions(com.google.protobuf.ExtensionRegistry)}.
 * {@link ai.protomolt.proto.projection.SourceResolver} is the pluggable lookup from declared
 * source names to descriptors, used for eager validation when a projection is built; failures on
 * either path raise {@link ai.protomolt.proto.projection.ProjectionException}.</p>
 *
 * <p>Field access and expression evaluation come from
 * {@link ai.protomolt.proto.mapper.ProtoFieldMapper} and
 * {@link ai.protomolt.proto.cel.CelEvaluator}; this package adds the descriptor-option layer
