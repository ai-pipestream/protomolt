...
public final class WorkflowCompiler {
    ...
    private static WorkflowStep.Builder withEdge(WorkflowStep.Builder builder,
        ...
        ai.pipestream.proto.grpc.workflow.v1.TypedEdge.Builder edgeBuilder =
                ai.pipestream.proto.grpc.workflow.v1.TypedEdge.newBuilder()
        ...
        if (step.fanOut() != null) {
            ...
            builder.setFanOut(ai.pipestream.proto.grpc.workflow.v1.FanOutSpec.newBuilder()
                    ...
                    .setFailurePolicy(fanOut.failurePolicy()
                            ...
                            ? ai.pipestream.proto.grpc.workflow.v1.BranchFailurePolicy
    ...
    private static ai.pipestream.proto.grpc.workflow.v1.CelMappingRule compileRule(
            ai.pipestream.proto.cel.CelMappingRule rule) {
        ai.pipestream.proto.grpc.workflow.v1.CelMappingRule.Builder builder =
                ai.pipestream.proto.grpc.workflow.v1.CelMappingRule.newBuilder()
