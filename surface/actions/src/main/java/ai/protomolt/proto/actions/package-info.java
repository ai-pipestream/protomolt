 ...
 * {@link ai.protomolt.proto.actions.StreamingAction} and write to a
 * {@link ai.protomolt.proto.actions.StreamEmitter}; the unary contract still holds, so fronts
 * that collect results need no special handling. Wherever an action takes a schema it follows
 * the convention implemented by {@link ai.protomolt.proto.actions.SchemaResolver}: a registered
