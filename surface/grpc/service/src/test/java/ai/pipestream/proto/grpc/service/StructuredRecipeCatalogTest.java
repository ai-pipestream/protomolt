...
/** Proves the host catalog exposes structured recipe execution to MCP/action callers. */
class StructuredRecipeCatalogTest {
    ...
    @Test
    void recordRecipeRunExecutesAnInlineStructuredStepThroughTheHostCatalog(
        ...
        ObjectNode result = catalog.execute("record-recipe-run", input);
