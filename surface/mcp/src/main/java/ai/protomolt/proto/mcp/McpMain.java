...
public final class McpMain {
    ...
    private static ActionCatalog catalog(ActionContext context,
                                         ...
                                         ai.protomolt.proto.registry.SchemaRegistryStore registry) {
        ...
        ai.protomolt.proto.grpc.invoke.ChannelFactory channels =
                ai.protomolt.proto.grpc.invoke.ChannelFactory.standard();
